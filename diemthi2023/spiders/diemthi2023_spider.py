...
class DiemThiSpider(scrapy.Spider):  
    ...
    pattern_province = api_endpoint + "?type=0&keyword={:02d}0*&kythi=THPT&nam=2023&cumthi=0"
    pattern_group = api_endpoint + "?type=0&keyword={:02d}{:04d}*&kythi=THPT&nam=2023&cumthi=0"
